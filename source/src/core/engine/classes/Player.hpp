...
public:
    ...
    Vec3_t pos;
    Vec3_t vel;
    float  yaw = 0.f; // m_angEyeAngles.y — horizontal facing direction
...
private:
    ...
    bool UpdatePawn();
    bool UpdateWeapon(uint64_t weaponServices);
    bool UpdateSkeleton(uint64_t sceneNode);
