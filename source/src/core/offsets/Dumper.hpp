...
private:
    ...
    DWORD64 ScanFromDisk(const std::string& sig, ProcessModule module); // legacy single-sig scan
    bool    GetModuleDiskPath(ProcessModule module, wchar_t* outPath, size_t outLen);
